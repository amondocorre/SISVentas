...
//$pdf->addClient("CL01");
//$pdf->addPageNumber("1");
$pdf->addClientAdresse("Raz�n Social: ".utf8_decode($reg_cli->nombre),"Domicilio: ".utf8_decode($reg_cli->direccion_calle)." - ".$reg_cli->direccion_departamento,$reg_cli->tipo_documento.": ".$reg_cli->num_documento,"Email: ".$reg_cli->email,"Telefono: ".$reg_cli->telefono);
...
require_once "../ajax/Letras.php";
 ...
 $V=new EnLetras(); 
 $con_letra=strtoupper($V->ValorEnLetras($reg_cli->total,"Bs.")); 
