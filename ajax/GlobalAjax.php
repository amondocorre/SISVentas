<?php
	...
	switch ($_GET["op"]) {
		...
		case 'SaveOrUpdate':			
			...
			if ($_FILES['imagenGlobal']['type'] == "image/jpg" || $_FILES['imagenGlobal']['type'] == "image/jpeg" || $_FILES['imagenGlobal']['type'] == "image/png")
			{
			if(move_uploaded_file($imagen, "../Files/Global/".$ruta)){
				...
				echo "Formato de imagen inválido o imagen vacía.";
			}
			break;
